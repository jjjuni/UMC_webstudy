    ...
    <S.ContentContainer>
      <S.ContentBox>
        <S.SignBox>
          ...
          <S.InputText placeholder='비밀번호를 입력해주세요' $borderBottom={'1px solid'} type={'password'}/>
          <S.InputText placeholder='비밀번호를 다시 입력해주세요' $borderRadius={'0 0 5px 5px'} type={'password'}/>
